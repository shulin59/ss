                    ...
                    <div class="card-deck">
                        <div class="card" style={{borderColor:'#f3e909'}}>
                            ...
                            <div class="card-body">
                                ...
                                <a className="btn downloadbtn rounded-pill shadow" href="" style={{textDecoration:'none', width:'50%', marginTop:'68px'}}>
                        ...
                        <div class="card" style={{borderColor:'#f3e909'}}>
                            ...
                            <div class="card-body">
                                ...
                                <a className="btn downloadbtn rounded-pill shadow" href="" style={{textDecoration:'none', width:'50%'}}>
                                    <i className="fa fa-eye">&ensp;View</i>
                                </a>
                            </div>
                        </div>
                        <div class="card" style={{borderColor:'#f3e909'}}>
                            ...
                            <div class="card-body">
                                ...
                                <a className="btn downloadbtn rounded-pill shadow" href="" style={{textDecoration:'none', width:'50%', marginTop:'102px'}}>
                                    <i className="fa fa-eye">&ensp;View</i>
                                </a>
                            </div>
                        </div>
